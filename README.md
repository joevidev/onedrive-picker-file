# onedrive-picker-file

This repository is a fork of [SDK to build and interface with OneDrive v8 Picker](https://github.com/OneDrive/samples/blob/master/samples/file-picking/sdk-pnptimeline) to make it a dependency of npm
